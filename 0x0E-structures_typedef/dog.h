...
/**
 * print_dog - it prints the content of a dog structure
 ...
 *
 * Description: The function creates a new dog structure
...
/**
 * free_dog - it frees the memory allocated for a dog structure
 * @d: Pointer to the dog structure to free
 *
 * Description: it function frees the memory allocated for a dog structure,
 * including the memory for the name and owner.
 */
